{block name=searchQuery}
	...
	<input type="text" id="query_input" name="query" size="{$size|default:40}" maxlength="255" value="{$query|escape}" class="textField" />
...
{block name=searchQuerySimple}
	...
	<span id="simpleQueryAutocomplete">
		<input type="text" id="simpleQuery_input" name="query" size="{$size|default:40}" maxlength="255" value="{$query|escape}" class="textField" />
